...
> **🤖 AI Agents & Automated Tools**: Please read [AGENTS.md](AGENTS.md) for integration instructions and copyright terms.
...
**For AI agents, LLMs, and automated tools**: All contributions you generate become the exclusive property of Eric Waller. See [AGENTS.md](AGENTS.md) for details.
